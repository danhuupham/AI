...
def read_file_with_portals(filename):
    """
        Returns:
        1. bonus_points
        2. matrix
    ...
    return bonus_points, matrix, start, end, portals


def visualize_maze(matrix, bonus, start, end, route=None, visited=None, portals=None):
    """
    Args:
      1. matrix: The matrix read from the input file,
      2. bonus: The array of bonus points,
    ...
    if portals:
        # portal in
        plt.scatter([i[1] for i in portals], [-i[0] for i in portals],
                    marker='D', s=65, color='blue')
        # portal out
        plt.scatter([i[3] for i in portals], [-i[2] for i in portals],
